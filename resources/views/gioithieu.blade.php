...
@section('addcss')
    <link rel="stylesheet" id="flatsome-main-css" href="{!!asset('/gioithieu_files/flatsome.css')!!}" type="text/css" media="all">
    <link rel="stylesheet" id="flatsome-style-css" href="{!!asset('/gioithieu_files/style.css')!!}" type="text/css" media="all">
@endsection
@section('content')
<main id="main" class="">
    ...
    <div id="content" role="main" class="content-area">
                    ...
                    <section class="section sec_about_intro" id="section_1544984533">
    ...
    <div class="row align-middle align-center" id="row-1497069089">
    <div class="col medium-8 small-12 large-6" data-animate="fadeInLeft" data-animated="true"><div class="col-inner">
        <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_1543304883">
    ...
    #section_1544984533 {
      ...
      padding-bottom: 0px;
        ...
        <section class="section sec_about_special" id="section_59926485">
            <div class="bg section-bg fill bg-fill  bg-loaded">
    ...
    <div class="row" id="row-1367351611">
    <div class="col medium-6 small-12 large-4" data-animate="fadeInRight" data-animated="true"><div class="col-inner">
    ...
    <g>
        <g>
            <path d="M341.254,106.704h-170.6c-35.3,0-64,28.7-64,64v170.7c0,35.3,28.7,64,64,64h170.7c35.3,0,64-28.7,64-64v-170.7
                ...
                C341.254,267.804,331.754,277.304,319.954,277.304z"></path>
        </g>
    </g>
    <g>
    </g>
    ...
    <g>
        <path d="M608.067,333.255l-44.973-71.364c-3.563-5.658-4.764-12.49-3.352-19.022l17.854-82.442
            ...
            l48.625,67.609l-12.356-83.253l26.116-11.27l51.831,67.718l-16.091-83.145l22.1-9.54l20.516,120.123L464.248,309.08z"></path>
    </g>
    <g>
    </g>
    <g>
    ...
    <g>
        <path style="fill:#030104;" d="M53.131,6C30.902,6,12.832,23.806,12.287,45.976H0l18.393,20.5l18.391-20.5H22.506
            ...
            z M49.498,25v23.45l15.027,15.024l4.949-4.949L56.5,45.55V25H49.498z"></path>
    </g>
    <g>
    </g>
    <g>
    ...
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 419.519 419.519" style="enable-background:new 0 0 419.519 419.519;" xml:space="preserve">
    <g>
        ...
        <path d="M386.784,190.429c-1.622-0.34-3.154-0.662-4.52-1.017c-15.092-3.925-22.58-6.263-27.827-16.394l-19.694-39.873
            ...
            c0-11.415,9.286-20.702,20.701-20.702c11.419,0,20.709,9.287,20.709,20.702C322.4,305.817,313.11,315.104,301.691,315.104z
             M263.206,187.26v-54.948h27.085c10.395,0,23.217,7.8,27.979,16.988l17.525,35.482c0.452,0.873,0.924,1.698,1.419,2.478H263.206z"></path>
    </g>
    <g>
    </g>
    <g>
            ...
            <div class="icon-box featured-box icon-box-left text-left">
                    ...
                    <div class="icon">
                        <div class="icon-inner">
                            <!--?xml version="1.0" encoding="iso-8859-1"?-->
    <!-- Generator: Adobe Illustrator 18.1.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 354.796 354.796" style="enable-background:new 0 0 354.796 354.796;" xml:space="preserve">
    <g>
        <g id="Layer_5_58_">
            <g>
                <g>
                    <path d="M265.442,109.092c-10.602-4.25-13.665-6.82-13.665-11.461c0-3.714,2.813-8.053,10.744-8.053
                        ...
                        c0-0.736,0.543-0.801,0.655-0.828c11.351-2.55,18.343-10.855,18.343-21.283C285.325,121.518,279.377,114.597,265.442,109.092z"></path>
                    <path d="M260.979,22.509c-51.816,0-93.818,42.005-93.818,93.818c0,51.814,42.002,93.82,93.818,93.82
                        ...
                        S300.785,188.404,260.979,188.404z"></path>
                </g>
                <g>
                    <path d="M335.733,255.61c-19.95,11.011-47.389,21.192-74.753,25.484c-24.346,3.818-70.148-5.39-70.148-16.265
                        ...
                        c20.593-4.787,78.888-39.334,90.065-50.072C363.711,265.176,350.244,247.601,335.733,255.61z"></path>
                    <path d="M74.426,224.74l-54.672-2.694c-4.221-0.208-8.532,2.973-9.581,7.066l-9.941,90.255c-1.048,4.094,1.55,7.578,5.773,7.741
                        ...
                        C57.356,308.378,50.589,315.145,42.24,315.145z"></path>
                </g>
            </g>
        </g>
    </g>
    ...
    #section_59926485 {
      ...
      padding-bottom: 0px;
        ...
        <section class="section sec_about_nhanxet" id="section_1122589475">
            <div class="bg section-bg fill bg-fill  bg-loaded">
    ...
    <div class="gap-element clearfix" style="display:block; height:auto; padding-top:60px"></div>
    <div class="row" id="row-20008406">
    <div class="col medium-4 small-12 large-4" data-animate="flipInY" data-animated="true"><div class="col-inner text-center">
      <div class="icon-box testimonial-box icon-box-top text-left">
                  ...
                  <img width="150" height="150" src="http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-2-150x150.png" class="attachment-thumbnail size-thumbnail" alt="" srcset="http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-2-150x150.png 150w, http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-2-100x100.png 100w, http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-2.png 300w" sizes="(max-width: 150px) 100vw, 150px">        </div>
    ...
    <div class="col medium-4 small-12 large-4" data-animate="flipInY" data-animated="true"><div class="col-inner text-center">
      <div class="icon-box testimonial-box icon-box-top text-left">
                    <div class="icon-box-img testimonial-image circle" style="width: 100px">
                  <img width="150" height="150" src="http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-4-150x150.png" class="attachment-thumbnail size-thumbnail" alt="" srcset="http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-4-150x150.png 150w, http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-4-100x100.png 100w, http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-4.png 300w" sizes="(max-width: 150px) 100vw, 150px">        </div>
                    <div class="icon-box-text p-last-0">
                                <div class="testimonial-text line-height-small italic test_text first-reset last-reset is-italic">
    ...
    <div class="col medium-4 small-12 large-4" data-animate="flipInY" data-animated="true"><div class="col-inner text-center">
      <div class="icon-box testimonial-box icon-box-top text-left">
                    <div class="icon-box-img testimonial-image circle" style="width: 100px">
                  <img width="150" height="150" src="http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-3-150x150.png" class="attachment-thumbnail size-thumbnail" alt="" srcset="http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-3-150x150.png 150w, http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-3-100x100.png 100w, http://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-3.png 300w" sizes="(max-width: 150px) 100vw, 150px">        </div>
                    <div class="icon-box-text p-last-0">
                                <div class="testimonial-text line-height-small italic test_text first-reset last-reset is-italic">
